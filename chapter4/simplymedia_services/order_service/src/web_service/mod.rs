    ...
    pub async fn start_webserver(&mut self) -> std::io::Result<()> {
        ...
        let server = HttpServer::new(move || {
            App::new()
                ...
                .route("/stop", web::get().to(api::stop))
                .service(api::order_list)
                .service(api::orderline_list)
                .service(api::order_list_all)
                .service(api::order_display)
                .service(web::resource("/order/create").route(web::post().to(api::order_create)))
                .service(
                    web::resource("/orderline/create").route(web::post().to(api::orderline_create)),
                )
                .service(web::resource("/order/cancel").route(web::post().to(api::order_cancel)))
                .service(
                    web::resource("/orderline/cancel").route(web::post().to(api::orderline_cancel)),
                )
                .service(web::resource("/order/update").route(web::post().to(api::order_update)))
                .service(
                    web::resource("/orderline/update").route(web::post().to(api::orderline_update)),
                )
            // .service(
